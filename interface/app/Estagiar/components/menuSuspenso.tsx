...
const MenuSuspenso: React.FC<MenuSuspensoProps> = ({ onChange, buscar, isVisible }) => {
    return (
        <div className={`fixed top-0 left-0 w-full ${isVisible ? 'block' : 'hidden'}`} style={{ maxWidth: '100%', zIndex: 99, boxShadow: '0px 6px 8px #0000004f', borderRadius: '0px 0px 5px 5px' }}>
