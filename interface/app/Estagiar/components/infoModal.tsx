...
const MoreInfo: React.FC<MoreInfoProps> = ({ titulo, codeVaga, detalheVaga, onRequestClose }) => {
  ...
  const regexCode = codeVaga.match(/\d+/);
  const numeroCodigo = regexCode ? regexCode[0] : ''; 
    ...
    <div className="flex flex-col gap-4 p-4 relative">
      ...
      <div className='pt-6 flex flex-col gap-4 items-center'>
        ...
        >
          ...
          <a href={`https://www.estagiar-br.com.br/Oportunidades/detalhe/estagio/${numeroCodigo}`} target='_blank'>Tenho Interesse</a>
      </button>
          <RedesSociais/>
      </div>
    </div>
